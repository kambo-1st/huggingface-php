...
use Kambo\Huggingface\ValueObjects\ApiKey;
...
final class Factory
{
     ...
     * If no URI is provided the factory will use the default Hugging Face API URI.
     */
    ...
    /**
     * Creates a new Hugging Face AI Client.
     */
